...
app.use('/api/admin/patologias', patologiasRoutes)
app.use('/api/admin/pacientes', pacientesRoutes)
app.use('/api/catalogos', catalogosRoutes)
app.use('/api/admin/paciente-patologias', pacientePatologiaRoutes)
app.use('/api/admin/programas', programasRoutes)
app.use('/api/admin/paciente-programas', pacienteProgramaRoutes)

app.use('/api/agenda/citas', citasRoutes)
app.use('/api/agenda/atencion', atencionRoutes)
